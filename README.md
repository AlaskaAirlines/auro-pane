...
```shell
$ npm i @aurodesignsystem/auro-pane
```
...
In cases where the project is not able to process JS assets, there are pre-processed assets available for use. See -- `auro-pane__bundled.js` for modern browsers. Legacy browsers such as IE11 are no longer supported.
...
```html
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/@aurodesignsystem/design-tokens@4.7.0/dist/tokens/CSSCustomProperties.css" />
...
<script src="https://cdn.jsdelivr.net/npm/@aurodesignsystem/auro-pane@2.2.0-beta.1/dist/auro-pane__bundled.js" type="module"></script>
```
