 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const a$2=Symbol.for(""),o$4=t=>{if(t?.r===a$2)return t?._$litStatic$},s$3=t=>({_$litStatic$:t,r:a$2}),i$4=(t,...r)=>({_$litStatic$:r.reduce(((r,e,a)=>r+(t=>{if(void 0!==t._$litStatic$)return t._$litStatic$;throw Error(`Value passed to 'literal' function must be a 'literal' result: ${t}. Use 'unsafeStatic' to pass non-literal values, but\n            take care to ensure page security.`)})(e)+t[a+1]),t[0]),r:a$2}),l$1=new Map,n$2=t=>(r,...e)=>{const a=e.length;let s,i;const n=[],u=[];let c,$=0,f=false;for(;$<a;){for(c=r[$];$<a&&void 0!==(i=e[$],s=o$4(i));)c+=s+r[++$],f=true;$!==a&&u.push(i),n.push(c),$++;}if($===a&&n.push(r[a]),f){const t=n.join("$$lit$$");void 0===(r=l$1.get(t))&&(n.raw=n,l$1.set(t,r=n)),e=u;}return t(r,...e)},u$1=n$2(x);
...
class AuroPane extends i$1 {
  ...
  getPrice(priceClasses) {
    if (this.price !== undefined) {
      ...
      return u$1`<span class="${e(priceClasses)}" part="price-slot">${displayPrice}</span>`;
    }
  ...
  render() {
    ...
    return u$1`
      <button
        class="${e(variantClasses.button)}"
        ?disabled="${this.disabled}"
        tabindex="${o(this.tabIndex ? this.tabIndex : undefined)}"
        aria-hidden="${o(this.ariaHidden ? "true" : undefined)}">
        <span class="${e(variantClasses.dayOfTheWeek)}">
          <${this.datetimeTag} type="weekday" weekday="short" utc="${parsedDate}"></${this.datetimeTag}>
        </span>
        <span class="${e(variantClasses.date)}">
