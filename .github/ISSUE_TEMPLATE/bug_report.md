...
labels: 'auro-pane, Type: Bug, not-reviewed'
---
...
## Verify the version of @alaskaairux/auro-pane you have installed
...
My project has @alaskaairux/auro-pane v<!-- insert npm version number here --> installed
