...
class AuroPane extends r {
  ...
  static register(name = "auro-pane") {
    AuroLibraryRuntimeUtils$1.prototype.registerComponent(name, AuroPane);
  }
  ...
  getPrice() {
    if (this.price !== undefined) {
      ...
      return x`<span class="${e(priceClasses)}" part="price-slot">${this.price}</span>`;
    }
  ...
  render() {
    ...
    return x`
      <button
        ...
        aria-hidden="${o(this.ariaHidden ? this.ariaHidden : undefined)}">
